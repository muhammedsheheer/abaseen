  ...
  return (
    <section className="relative flex h-full w-full justify-center bg-[#0f1d22]">
      ...
      <div className="z-30 flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-4 py-12">
        <h3 className="special-one font-stone text-xl text-primary md:-ml-[50px] md:text-3xl">
          Recommendations
        </h3>
        ...
        <div className="flex w-full items-center justify-center py-5">
          <Link href="/menu">
            <Button
              variant="image"
              className="font-open bg-button-hover px-10 py-6 font-[200] uppercase leading-[22.4px] tracking-[13%] text-white"
            >
              View Menu
            </Button>
          </Link>
