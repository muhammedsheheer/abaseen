...
const ViewMenu = ({ }) => {
  ...
  return (
    <Button
      asChild
      className="table-button z-50 flex aspect-square h-24 flex-col items-center justify-center rounded-full bg-[#0b1315] px-0 py-0 text-center text-xs uppercase text-[#c6a87f] hover:bg-[#1D1D1D]"
    >
      <Link href="/table-booking">
        <Icons.dining color="#c6a87f" />
        Table
        <br />
        Booking
      </Link>
